...
export const TablePage = () => {
    ...
    return (
        <PageLayout
            title="Cambios"
        >
            <CustomToolbar showSearch onCreate={()=>{}} onFilter={()=> setVisibleFilters(true)} />
            <DataTableExample />
            <CustomFiltersSidebar visible={visibleFilters} onHide={() => setVisibleFilters(false)} onClearFilters={() => {}} onApplyFilters={() => {}}>
                <div>
                    ...
                    <div className="mt-3">
                        <DropDown label="Inventario" value={null} onChange={(value) => {console.log(value)}} options={[{ label: "Opción 1", value: "1" }, { label: "Opción 2", value: "2" }]} />
                    </div>
                </div>
